...
import net.marvin.tutorialmod.block.entity.GemInfusingStationBlockEntity;
...
public class GemInfusingStationMenu extends AbstractContainerMenu {
    ...
    public GemInfusingStationMenu(int id , Inventory inv, BlockEntity entity, ContainerData data){
        ...
        this.blockEntity = (GemInfusingStationBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level,blockEntity.getBlockPos()), player, BlockRegistry.GEM_INFUSING_STATION.get());
    }
